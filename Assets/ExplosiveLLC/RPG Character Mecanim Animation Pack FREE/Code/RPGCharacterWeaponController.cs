   ...
   //
        ...
        public IEnumerator _WeaponVisibility(Weapon weaponNumber, bool visible, bool dual)
        {
			...
			if (weaponManager != null)
			{
				...
				if (weaponManager.WeaponDataDict.TryGetValue(weaponType, out var rightWeaponData))
				{
					SafeSetVisibility(rightWeaponData.weaponInstance, true);
				}
	            
				if (weaponManager.WeaponDataDict.TryGetValue(weaponType, out var leftWeaponData))
				{
